...
public:
    ...
    char GetPixel(Point p) const noexcept {
        ...
        Point local_coords{p.x % Tile::SIZE, p.y % Tile::SIZE};
        return tiles_[tile_index]->GetPixel(local_coords);
    }
    ...
    void SetPixel(Point p, char color) {
        ...
        // Write to the tile using Copy-on-Write
        tiles_[tile_index].Write([&](Tile& tile) { tile.SetPixel(local_coords, color); });
    }
